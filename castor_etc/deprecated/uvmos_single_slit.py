...
"""
UVMOS Spectroscopy - Single Slit
===================
.. caution::
    This contains a deprecated version of the UVMOS implementation that does not enable dyanmic slits.
...
class UVMOS_SingleObject:
    ...
    def _extraction(self, detector, pix_waves, extraction_width, extraction_lowerlim, extraction_upperlim):
        ...
        test = detector[extraction_lowerlim:extraction_upperlim, 1:2]
    ...
    def calc_source_CASTORSpectrum(self, extraction_width=1, extraction_lowerlim=0, extraction_upperlim='max' ):
        ...
        x = self.SourceObj.wavelengths.to("AA").value # Wavelength in angstrom
