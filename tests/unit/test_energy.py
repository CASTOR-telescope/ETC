...
from castor_etc.utils.conversions import calc_photon_energy
...
class TestEnergy(unittest.TestCase):
    ...
    def test_calc_photon_energy_wavelength_single(self):
        ...
        for result, truth in zip(results, truths, strict=False):
    ...
    def test_calc_photon_energy_wavelength_multi(self):
        ...
        truths = [true_energy, true_uncer]
        for result_arr, truth_arr in zip(results, truths, strict=False):
            for result, truth in zip(result_arr, truth_arr, strict=False):
                self.assertAlmostEqual(result, truth, delta=_TOL)
